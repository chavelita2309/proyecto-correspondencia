...
<header class="bg-white shadow-md z-10 relative">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-center items-center">
        ...
        <h1 class="text-xl font-bold text-gray-800">Sistema Web de Gestión de Correspondencia - Ingeniería Textil U.P.E.A.</h1>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-grado\resources\views/auth/login.blade.php ENDPATH**/ ?>
...
<body>
    ...
    <h2>LIBRO DE CORRESPONDENCIA <?php echo e(ucfirst($tipo)); ?></h2>
    ...
    <table>
        ...
        <tbody>
            <?php $__currentLoopData = $correspondencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($item->rut); ?></td>

                    <td><?php echo e(\Carbon\Carbon::parse($item->fecha)->format('d/m/Y')); ?></td>
                    <td><?php echo e($item->destinatario); ?></td>
                    <td><?php echo e($item->remitente); ?><br> <?php echo e($item->unidad); ?></td>
                    <td><?php echo e($item->referencia); ?></td>
                    <td><?php echo e($item->fojas); ?></td>
...
<?php /**PATH C:\xampp\htdocs\proyecto-grado\resources\views\reportes\libro.blade.php ENDPATH**/ ?>
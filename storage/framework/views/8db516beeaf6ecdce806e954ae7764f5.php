    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="<?php echo e(route('usuarios.store')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="roles[]" id="roles" required
                            ...
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($rol->name); ?>" <?php echo e(old('roles') == $rol->name ? 'selected' : ''); ?>>
                                    <?php echo e($rol->name); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-grado\resources\views\usuarios\crear.blade.php ENDPATH**/ ?>
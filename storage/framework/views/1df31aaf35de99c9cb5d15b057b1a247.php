...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-xl font-semibold">Permisos para el rol: <?php echo e($role->name); ?></h2>
     <?php $__env->endSlot(); ?>

    <div class="p-4">
        <form action="<?php echo e(route('roles.permisos.update', $role)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-grado\resources\views\admin\roles\permisos.blade.php ENDPATH**/ ?>
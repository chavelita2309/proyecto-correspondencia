        ...
        <div class="flex flex-col justify-superior">
            <div class="w-full max-w-6xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                <header class="px-5 py-4 border-b border-gray-100">
                    <h2 class="font-semibold text-yellow-800 text-lg">Trámites archivados</h2>
                </header>
                    ...
                    <table class="table-auto w-full">
                        ...
                        <tbody class="text-sm divide-y divide-gray-100">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="6" class="text-center py-4 text-gray-500">No hay trámites archivados.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto-grado\resources\views\Tramites\despachados.blade.php ENDPATH**/ ?>